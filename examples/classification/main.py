...
from examples.classification.pretrain_viewgen import main as pretrain_viewgen
...
if __name__ == "__main__":
    ...
    cfg.update(opts)
    if args.fold != -1:
        cfg.dataset.common.fold = args.fold
    if cfg.seed is None:
    ...
    if 'pretrain_viewgen' in cfg.mode:
        main = pretrain_viewgen
        if 'resume' in cfg.mode:
            cfg.mode = 'resume'
        if 'test' in cfg.mode:
            cfg.mode = 'test'
    else:
